...
####Merini theme
	...
	### Wallpapers
	install -d $(DESTDIR)/usr/share/desktop-base/merini-theme/wallpaper/contents/images
	$(INSTALL_DATA) merini-theme/wallpaper/metadata.desktop $(DESTDIR)/usr/share/desktop-base/merini-theme/wallpaper
	$(INSTALL_DATA) merini-theme/wallpaper/gnome-background.xml $(DESTDIR)/usr/share/desktop-base/merini-theme/wallpaper
	$(INSTALL_DATA) $(wildcard merini-theme/wallpaper/contents/images/*) $(DESTDIR)/usr/share/desktop-base/merini-theme/wallpaper/contents/images/
	...
	cd $(DESTDIR)/usr/share/wallpapers && ln -s /usr/share/desktop-base/merini-theme/wallpaper Merini

	### Lockscreen
	install -d $(DESTDIR)/usr/share/desktop-base/merini-theme/lockscreen/contents/images
	$(INSTALL_DATA) merini-theme/lockscreen/metadata.desktop $(DESTDIR)/usr/share/desktop-base/merini-theme/lockscreen
	$(INSTALL_DATA) merini-theme/lockscreen/gnome-background.xml $(DESTDIR)/usr/share/desktop-base/merini-theme/lockscreen
	$(INSTALL_DATA) $(wildcard merini-theme/lockscreen/contents/images/*) $(DESTDIR)/usr/share/desktop-base/merini-theme/lockscreen/contents/images/
	# Lock screen symlink for KDE
	install -d $(DESTDIR)/usr/share/wallpapers
	cd $(DESTDIR)/usr/share/wallpapers && ln -s /usr/share/desktop-base/merini-theme/lockscreen MeriniLockScreen

	### Login background
	install -d $(DESTDIR)/usr/share/desktop-base/merini-theme/login
	$(INSTALL_DATA) $(wildcard merini-theme/login/*) $(DESTDIR)/usr/share/desktop-base/merini-theme/login
